 ...
 */
final class Version20200415121133 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, reference BIGINT NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, products VARCHAR(255) NOT NULL, cost DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
